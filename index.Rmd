...
# How does using Sustainability Studies degree completions as a proxy for sustainability of colleges compare to using other methods of measurement of sustainability?
...
Top30 <- read_excel("data/Top30.xlsx") %>%
  ...
  select(Institution, `Green Power Proportion of Total Energy Used`,
         `Green Power (kWh)`)
knitr::kable(Top30)  
